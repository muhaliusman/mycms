    ...
    b = wpNavMenu = {
        ...
        jQueryExtensions: function() {
            a.fn.extend({
                ...
                updateDepthClass: function(b, c) {
                    return this.each(function() {
                        var d = a(this);
                        c = c || d.menuItemDepth(), a(this).removeClass("menu-item-depth-" + c).addClass("menu-item-depth-" + b).find('input.menu-item-data-depth').val(b)
                    })
                },
                ...
                addSelectedToMenu: function(c) {
                    return 0 === a("#menu-to-edit").length ? !1 : this.each(function() {
                        var d = a(this),
                            e = {},
                            f = d.find(MenuI18n.oneThemeLocationNoMenuI18n && 0 === d.find(".tabs-panel-active .categorychecklist li input:checked").length ? '#page-all li input[type="checkbox"]' : ".tabs-panel-active .categorychecklist li input:checked"),
                            g = /menu-item\[([^\]]*)/;
        ...
        refreshAdvancedAccessibility: function() {
            a(".menu-item-settings .field-move a").css("display", "none"), a(".item-edit").each(function() {
                ...
                0 !== p && (b = l.find(".MenuI18n-move-up"), b.prop("title", MenuI18n.moveUp).css("display", "inline")), 0 !== p && n && (b = l.find(".MenuI18n-move-top"), b.prop("title", MenuI18n.moveToTop).css("display", "inline")), p + 1 !== t && 0 !== p && (b = l.find(".MenuI18n-move-down"), b.prop("title", MenuI18n.moveDown).css("display", "inline")), 0 === p && 0 !== u && (b = l.find(".MenuI18n-move-down"), b.prop("title", MenuI18n.moveDown).css("display", "inline")), n || (b = l.find(".MenuI18n-move-left"), c = MenuI18n.outFrom.replace("%s", r), b.prop("title", MenuI18n.moveOutFrom.replace("%s", r)).html(c).css("display", "inline")), 0 !== p && l.find(".menu-item-data-parent-id").val() !== l.prev().find(".menu-item-data-db-id").val() && (b = l.find(".MenuI18n-move-right"), c = MenuI18n.under.replace("%s", s), b.prop("title", MenuI18n.moveUnder.replace("%s", s)).html(c).css("display", "inline")), n ? (d = a(".menu-item-depth-0"), e = d.index(l) + 1, t = d.length, f = MenuI18n.menuFocus.replace("%1$s", o).replace("%2$d", e).replace("%3$d", t)) : (g = l.prevAll(".menu-item-depth-" + parseInt(m - 1, 10)).first(), h = g.find(".menu-item-data-db-id").val(), i = g.find(".menu-item-title").text(), j = a('.menu-item .menu-item-data-parent-id[value="' + h + '"]'), e = a(j.parents(".menu-item").get().reverse()).index(l) + 1, f = MenuI18n.subMenuFocus.replace("%1$s", o).replace("%2$d", e).replace("%3$s", i)), k.attr("aria-label", f).html(f)
            })
        },
        ...
        initToggles: function() {
            postboxes.add_postbox_toggles("nav-MenuI18n"), columns.useCheckboxesForHidden(), columns.checked = function(b) {
        ...
        initManageLocations: function() {
            ...
            }), a(".menu-location-MenuI18n select").on("change", function() {
        ...
        attachUnsavedChangesListener: function() {
            a("#menu-management input, #menu-management select, #menu-management, #menu-management textarea, .menu-location-MenuI18n select").change(function() {
                b.registerChange()
            }), 0 !== a("#menu-to-edit").length || 0 !== a(".menu-location-MenuI18n select").length ? window.onbeforeunload = function() {
