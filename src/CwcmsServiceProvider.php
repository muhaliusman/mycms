...
class CwcmsServiceProvider extends ServiceProvider
{
    ...
    protected function bootForConsole()
    {
        ...
        /*$this->publishes([
            __DIR__.'/../resources/views' => base_path('resources/views/vendor/cerberusworks'),
        ], 'cwcms.views');*/

        // Publishing assets.
        /*$this->publishes([
            __DIR__.'/../resources/assets' => public_path('vendor/cerberusworks'),
        ], 'cwcms.views');*/

        // Publishing the translation files.
        /*$this->publishes([
            __DIR__.'/../resources/lang' => resource_path('lang/vendor/cerberusworks'),
        ], 'cwcms.views');*/
